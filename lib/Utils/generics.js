...
exports.isWABusinessPlatform = exports.getCodeFromWSError = exports.getCallStatusFromNode = exports.getErrorCodeFromStreamError = exports.getStatusFromReceiptType = exports.generateMdTagPrefix = exports.fetchLatestWaWebVersion = exports.fetchLatestBaileysVersion = exports.printQRIfNecessaryListener = exports.bindWaitForConnectionUpdate = exports.generateMessageID = exports.delayCancellable = exports.delay = exports.debouncedTimeout = exports.unixTimestampSeconds = exports.toNumber = exports.encodeBigEndian = exports.generateRegistrationId = exports.encodeWAMessage = exports.unpadRandomMax16 = exports.writeRandomPadMax16 = exports.getKeyAuthor = exports.BufferJSON = exports.Browsers = void 0;
...
const toNumber = (t) => typeof t === "object" && t
    ? "toNumber" in t
        ? t.toNumber()
        : t.low
    : t;
...
const generateMessageID = () => {
    let randomString = (0, crypto_1.randomBytes)(16).toString('hex').toUpperCase().split('');
    const randomPosition = Math.floor(Math.random() * randomString.length);
    randomString[randomPosition] = String.fromCharCode(97 + Math.floor(Math.random() * 26));
