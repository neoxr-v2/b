...
export declare const makeMessagesSocket: (config: SocketConfig) => {
    ...
    relayMessage: (jid: string, message: proto.IMessage, { messageId: msgId, participant, additionalAttributes, useUserDevicesCache, cachedGroupMetadata, statusJidList, additionalNodes, }: MessageRelayOptions) => Promise<string | undefined>;
