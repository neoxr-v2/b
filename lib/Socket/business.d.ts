...
export declare const makeBusinessSocket: (config: SocketConfig) => {
    ...
    extractNewsletterMetadata: (node: BinaryNode, isCreate?: boolean) => import("../Types").NewsletterMetadata;
    ...
    newsletterWMexQuery: (jid: string | undefined, queryId: import("../Types").QueryIds, content?: object) => Promise<BinaryNode>;
