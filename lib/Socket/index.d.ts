...
declare const makeWASocket: (config: UserFacingSocketConfig) => {
    ...
    extractNewsletterMetadata: (node: import("..").BinaryNode, isCreate?: boolean) => import("../Types").NewsletterMetadata;
    ...
    newsletterWMexQuery: (jid: string | undefined, queryId: import("../Types").QueryIds, content?: object) => Promise<import("..").BinaryNode>;
    newsletterQuery: (jid: string, type: "get" | "set", content: import("..").BinaryNode[]) => Promise<import("..").BinaryNode>;
