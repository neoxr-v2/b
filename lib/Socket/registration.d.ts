...
export declare const makeRegistrationSocket: (config: SocketConfig) => {
    ...
    relayMessage: (jid: string, message: import("../Types").WAProto.IMessage, { messageId: msgId, participant, additionalAttributes, useUserDevicesCache, cachedGroupMetadata, statusJidList, additionalNodes, }: import("../Types").MessageRelayOptions) => Promise<string | undefined>;
    ...
    extractNewsletterMetadata: (node: import("../WABinary").BinaryNode, isCreate?: boolean) => import("../Types").NewsletterMetadata;
    ...
    newsletterWMexQuery: (jid: string | undefined, queryId: import("../Types").QueryIds, content?: object) => Promise<import("../WABinary").BinaryNode>;
    newsletterQuery: (jid: string, type: "get" | "set", content: import("../WABinary").BinaryNode[]) => Promise<import("../WABinary").BinaryNode>;
