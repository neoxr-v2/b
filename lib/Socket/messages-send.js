    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, additionalAttributes, useUserDevicesCache, cachedGroupMetadata, statusJidList, additionalNodes, }) => {
        ...
        await authState.keys.transaction(async () => {
            ...
            if (isGroup || isStatus) {
                ...
                // Message delete
                if (((_c = message.protocolMessage) === null || _c === void 0 ? void 0 : _c.type) ===
                ...
                for (const { user, device } of devices) {
                    ...
                    const jid = (0, WABinary_1.jidEncode)(isMe && isLid
                        ? ((_f = (_e = authState.creds) === null || _e === void 0 ? void 0 : _e.me) === null || _f === void 0 ? void 0 : _f.lid.split(":")[0]) || user
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            if (typeof content === "object" &&
                ...
                if (isDeleteMsg) {
                    ...
                    if (((0, WABinary_1.isJidGroup)((_a = content.delete) === null || _a === void 0 ? void 0 : _a.remoteJid) &&
                        !((_b = content.delete) === null || _b === void 0 ? void 0 : _b.fromMe)) ||
